$(document).ready(function () {
      ...
      success: function (res) {
        ...
        $('#signOut').click(function () {
          $('#hiddenFrame').on('load', function (event) {
            location.href = '/bim/api/forge/oauth/signout';
          });
  ...
  function prepareUserHubsTree() {
    $('#userHubs').jstree({
      'core': {
        ...
        'multiple': false,
        'data': {
          "url": '/bim/api/forge/datamanagement',
          "dataType": "json",
          'cache': false,
          'data': function (node) {
  ...
  function showUser() {
    jQuery.ajax({
      url: '/bim/api/forge/user/profile',
